# pdf_preprocessor/llm_extct_meta.py
...
from prompts.schema_and_prompts import schema_1, system_prompts
...
def prepare_context_for_llm(pdf_data: Dict[str, List]) -> Dict[str, str]:
    ...
    """
    global schema_1
    from prompts.schema_and_prompts import schema_1
...
def main():
    ...
    parser.add_argument("--analyzed_data", default="results/analyzed_data/all_documents_analyzed.json",
